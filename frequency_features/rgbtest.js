...
function msg_float(v){
	//sets the variables for wave length and spectral
	if (inlet == 0){
		wavelength = v;
}
	if(inlet == 1){
	...
	if (Spectral > 0){
		anything(wavelength, Spectral);
}
}


function anything(wavelength, Spec) {
...
function _getColorFromWaveLength (wavelength, Spec) {
...
// The result is left-padded with "0" (zeros) to fill out the string as needed.
